...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select * from PayBook,GroupInvite where GroupInvite.groupName = "+ request.getParameter("groupName")+" and PayBook.groupName ="+request.getParameter("groupName")+"; ");
